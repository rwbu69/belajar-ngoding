...
function scoreChecker(score) {
    let result;
      if(score >= 90){
       return result = 'Selamat! Anda mendapatkan nilai A!';
      }else if(score > 80 || score < 90){
       return result = 'Anda mendapatkan nilai B';
      }else if(score > 70 || score < 80){
       return result = 'Anda mendapatkan nilai C';
      }else if(score > 60 || score < 70){
       return result = 'Anda mendapatkan nilai D';
      }else{
